...
contract DrivenDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("Driven_Dividend_Tracker", "Driven_Dividend_Tracker") {
        // TODO: Change this
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 3500 * (10**18); //must hold 3500 tokens
    }
...
contract DrivenX is ERC20, Ownable {
    ...
    // TODO: Change this
    address public marketingWallet = 0xBC35BF2E924087F805027E8Dad0c8851Ffd3D27b;
    ...
    // TODO: Change this:
    constructor() public ERC20("DVX", "DRIVENx") {
    ...
    function updateMinterAddress(address newMinterAddress) public onlyOwner {
        require(newMinterAddress != minterAddress, "The minter address is already this address");
...
contract MasterChefV2 is Ownable, ReentrancyGuard {
    ...
    function deposit(uint256 _pid, uint256 _amount) public nonReentrant {
        ...
        if (user.amount > 0) {
            ...
            if (pending > 0) {
                egg.mint(msg.sender, pending);
                egg.mint(feeAddress, pending.mul(10).div(100));
            }
        }
        if (_amount > 0) {
            ...
            _amount = amountAfter.sub(amountBefore); // This is to keep track of the real fee
